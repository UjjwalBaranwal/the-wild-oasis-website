...
export default async function Page() {
  ...
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* Note:- Very important here as we dont using statis approach of Image tag , so that we have to give the hieght and width to the Image tag but we donot give here by making the parent relative and giving it the height and width {in this case aspect-square} and using fill in the the Image tag */}
